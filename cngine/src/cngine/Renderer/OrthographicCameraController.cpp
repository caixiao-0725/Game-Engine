...
namespace Cngine {
	...
	void OrthographicCameraController::OnEvent(Event& e)
	{
		...
		dispatcher.Dispatch<MouseScrolledEvent>(CG_BIND_EVENT_FN(OrthographicCameraController::OnMouseScrolled));
		dispatcher.Dispatch<WindowResizeEvent>(CG_BIND_EVENT_FN(OrthographicCameraController::OnWindowResized));
	}
